<?php
/**
 * Client Search API - Session-based (MIGRATED TO SanctumEMHR)
 * Searches for clients using session authentication
 */
...
try {
    ...
    if (!$session->isAuthenticated()) {
        error_log("Client search: Not authenticated");
    ...
    error_log("Client search: User authenticated - $userId");
    ...
    error_log("Client search returned " . count($results) . " results");
